% The goal of this program is to understand the while loops in a way that
% we can put the Arudino commands in there and have it work.  When we
% create this program with a real sensor and motor, we will use the sensor
% to choose a threshold to open or close the gate.  To start we will ask
...
%******************************************************************
%
%   Add this command 2 places in the code below to make this program
%          function correctly
%
%*******************************************************************
%*******************************************************************
